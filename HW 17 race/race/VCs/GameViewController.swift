...
//    static var carImageName = UserDefaults.standard.string(forKey: UserDefault.userCarImageName.rawValue)
//    static var obstacleImageName = UserDefaults.standard.string(forKey: UserDefault.userObstacleImageName.rawValue)
//    static var speedCar = UserDefaults.standard.double(forKey: UserDefault.userSpeedCar.rawValue)
    ...
    override func viewDidLoad() {
        ...
        let arrayOfObstacleImageView: [UIImageView] = [obstacle1ImageView, obstacle2ImageView, obstacle3ImageView, obstacle4ImageView]
    ...
    func moveCarToLeft() {
        UIView.animate(withDuration: 0.3, delay: 0, options: [.curveLinear], animations: {
            ...
            let arrayOfObstacleImageView: [UIImageView] = [self.obstacle1ImageView, self.obstacle2ImageView, self.obstacle3ImageView, self.obstacle4ImageView]
    ...
    func backToMainView() {
        HighScoreTableViewController.arrayOfResultGame.append(ResultGame(userName: ViewController.user.userName, time: GameViewController.dateFormatter.string(from: Date()), score: timeScore))
